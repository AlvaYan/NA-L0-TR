...
rep=200
R=6
DV_poi=matrix(rep(0),rep,8)
LL_poi=matrix(rep(0),rep,7)
MSE_poi=matrix(rep(0),rep,7)
cMSE_poi=matrix(rep(0),rep,7)
PMAE_poi=matrix(rep(0),rep,9)#
...
for (r in 1:rep)
{
  ...
  start=Sys.time()
  result1=our(x,y,beta0=beta0,beta,betaols,data0)
  end=Sys.time()
  t1=end-start
